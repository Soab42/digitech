    ...
    <div>
      ...
      <div className=" p-5 py-20 ">
        ...
        <div className="max-w-7xl mx-auto">
          <p className="uppercase text-xl text-teal-600 ml-20">
            our specializes
          </p>
          ...
          <div className="flex flex-col  gap-5 w-full">
            ...
            <ul className="list-disc space-y-2 p-2">
              <li className="flex gap-2 p-1">
                <Undo2 className="w-6 h-6 text-teal-500 rotate-180" /> Custom
                websites and web apps tailored to your business needs.
              </li>
              <li className="flex gap-2 p-1">
                <Undo2 className="w-6 h-6 text-teal-500 rotate-180" />
                Seamless cloud migration and scalable cloud architecture
                solutions.
              </li>
              <li className="flex gap-2 p-1">
                <Undo2 className="w-6 h-6 text-teal-500 rotate-180" />
